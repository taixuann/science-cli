...
IV_TECHNIQUES = {"iv-sweep", "iv-breakdown", "iv-leakage"}
PULSE_TECHNIQUES = {
    "pulse-endurance", "pulse-retention", "pulse-switching",
    "pulse-forming", "pulse-set", "pulse-reset", "pulse-read",
    "pulse-ivd", "pulse-stp", "pulse-ppf",
}
