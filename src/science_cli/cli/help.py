...
COMMAND_HELP: Dict[str, dict] = {
    ...
    "raman": {
        ...
        "subcommands": {
            ...
            "raman info [--fzf]":     {"desc": "Show full header metadata (laser, grating, etc.)", "usage": "raman info 260526_PDA-ITO_raman_01.txt"},
            "raman plot [--fzf]":     {"desc": "Plot Raman spectrum with metadata annotation", "usage": "raman plot 260526_PDA-ITO_raman_01.txt [--grid] [--name out.pdf]"},
            "raman analyze [--fzf]":  {"desc": "Peak finding, baseline, normalization, CSV export", "usage": "raman analyze 260526_PDA-ITO_raman_01.txt [--baseline] [--norm] [--prominence 500]"},
        },
        "flags": {
            ...
            "--fzf":        {"desc": "Interactive file picker (info, plot, analyze)"},
        ...
        "examples": [
            ...
            "raman plot --fzf --grid",
            "raman plot 260526_PDA(q)-ITO_raman-sers_01.txt --name raman_spectrum.pdf",
            "raman analyze --fzf --baseline --norm",
