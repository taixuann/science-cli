...
def afm_handler(args: list) -> None:
    ...
    if sub == "ls":
        ...
        console.print("[yellow]⚠️  'sci afm plot' is deprecated. Use 'sci plot --technique afm [FLAGS]' instead.[/yellow]")
        _afm_plot(sub_args)
    elif sub == "analyze":
        console.print("[yellow]⚠️  'afm analyze' is deprecated. Use 'analyze --technique afm' instead.[/yellow]")
