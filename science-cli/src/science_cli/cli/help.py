...
COMMAND_HELP: Dict[str, dict] = {
    ...
    "memristor": {
        ...
        "subcommands": {
            "memristor init":         {"desc": "Scaffold a devices.yaml for memristor array", "usage": "memristor init --rows 4 --cols 4 --label 'My Device'"},
        ...
        "examples": [
            "memristor init --rows 4 --cols 4 --label 'ITO/PDA/Ta'",
            "memristor ls --matrix",
